    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorBook", x => new { x.AuthorsId, x.BooksNumber });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorBook_Products_BooksNumber",
                        column: x => x.BooksNumber,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorBook_BooksNumber",
                table: "AuthorBook",
                column: "BooksNumber");
